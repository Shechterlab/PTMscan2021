---
title: "GluC IP Peptide and Protein Results"
...
Created: 09.29.90
The goal of this notebook is to clean up the GluC IP Results for tidy data.  Specificially, create basic plots and clean up the labels and data organization. 

Note: Changed to not filter peptides. Also, oxidation was removed and peptides were summed by sequence and modifications (excluding oxidation). 
...
Peptide <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/GluC_MethylIP_PeptideGroups.txt")
PSMs <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/GluC_MethylIP_PSMs.txt")
FileID <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/GluC_MethylIP_InputFiles.txt")
protein <- readRDS("C:/Users/maxim/OneDrive/Shechter/Processed_Data/All_Protein_Gene.RDS")
...
# Renames columns, creates two new columns for peptide site in protein and removes columns. 
...
```{r Break Data into IP specific data chunks}
...
saveRDS(MMA, "C:/Users/maxim/OneDrive/Shechter/Processed_Data/GluC_02/MMA_tidy_TheoMW_03.RDS")
saveRDS(SDMA, "C:/Users/maxim/OneDrive/Shechter/Processed_Data/GluC_02/SDMA_tidy_TheoMW_03.RDS")
saveRDS(ADMA, "C:/Users/maxim/OneDrive/Shechter/Processed_Data/GluC_02/ADMA_tidy_TheoMW_03.RDS")
