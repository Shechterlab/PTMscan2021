...
---
title: "Trypsin Input Samples"
output: html_notebook
editor_options: 
  chunk_output_type: console
---
Created Sometime in 2020, modified 02/2021
The goal of this notebook is to process the trypsin input results with the search including methylations. 
...
Peptide <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/Input_Tryp_Methyl_4_PeptideGroups.txt")
PSMs <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/Input_Tryp_Methyl_4_PSMs.txt")

PeptideM <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/Input_Tryp_PeptideGroups.txt")
PSMsM <- import("C:/Users/maxim/OneDrive/Shechter/PD_Results_Jan2021/Input_Tryp_PSMs.txt")

geneinfo <- readRDS("C:/Users/maxim/OneDrive/Shechter//Processed_Data/All_Protein_Gene.RDS")
```
...
```{r}
# Adds in gene.symbol
Peptide_long <- left_join(Peptide_long, geneinfo, by = NULL)
```
...
Peptide_Modification.a <- Peptide_Modification.a %>% 
  rowwise() %>% 
  filter(!Sequence.Length %in% Integer.1:Integer.5)
...
saveRDS(Peptide_long.2, "C:/Users/maxim/OneDrive/Shechter/Processed_Data/Tryp_03/Input_Tryp_tidy_peptides_TheoMW.RDS")
