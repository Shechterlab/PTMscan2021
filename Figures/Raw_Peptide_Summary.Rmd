...
```{r}
MMA_trypsin <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/Tryp_02/MMA_tidy_TheoMW_03.RDS")
ADMA_trypsin <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/Tryp_02/ADMA_tidy_TheoMW_03.RDS")
SDMA_trypsin <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/Tryp_02/SDMA_tidy_TheoMW_03.RDS")


MMA_gluc <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/MMA_tidy_TheoMW_03.RDS")
ADMA_gluc <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/ADMA_tidy_TheoMW_03.RDS")
SDMA_gluc <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/SDMA_tidy_TheoMW_03.RDS")
...
dataframes <- lapply(dataframes, function(x) {x <- x[!duplicated(x[c(2,4,10,13)]),];x})
dataframes <- lapply(dataframes, function(x) {x <- x[!is.na(x$Abundance),];x})
dataframes <- lapply(dataframes, function(x) {x <- x[!x$Accession == 'ALBU_BOVIN',];x})
