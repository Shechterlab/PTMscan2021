...
Peptide_longer <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/Tryp_02/SDMA_tidy_TheoMW_03.RDS")
...
plot_single(dep, proteins = c("CHTOP.12"))
...
write.csv(df_wide, 'Trypsin_SDMA_perResidue_log2FC.csv')
