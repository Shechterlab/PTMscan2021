...
Peptide_longer_SDMA <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/SDMA_tidy_TheoMW_03.RDS")
Peptide_longer_SDMA$group <- 'SDMA'
Peptide_longer_MMA <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/MMA_tidy_TheoMW_03.RDS")
Peptide_longer_MMA$group <- 'MMA'
Peptide_longer_ADMA <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/ADMA_tidy_TheoMW_03.RDS")
...
plot_single(dep, proteins = c("TAF15.2"), type= "centered")
...
#write.csv(df_wide, 'Gluc_MMA_ADMA_SDMA_PerPeptide.csv')
...
#write.csv(df_wide, 'Gluc_MMA_ADMA_SDMA_PerResidue.csv')
