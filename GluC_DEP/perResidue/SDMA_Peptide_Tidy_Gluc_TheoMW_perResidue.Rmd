...
Peptide_longer <- readRDS("C:/Users/maxim/OneDrive - Montefiore Medicine/Shechter/Processed_Data/GluC_02/SDMA_tidy_TheoMW_03.RDS")
...
data_se <- make_se(data_unique, grep("SDMA", colnames(data_unique)), experimental_design)
...
data_diff <- test_diff(data_imp, type = "manual", 
                              test = c("GSK591_SDMA_vs_DMSO_SDMA", 'MS023_SDMA_vs_DMSO_SDMA', 'MS023_SDMA_vs_GSK591_SDMA'))
...
plot_volcano(dep, contrast = "GSK591_SDMA_vs_DMSO_SDMA", label_size = 2, add_names = TRUE)
plot_volcano(dep, contrast = "MS023_SDMA_vs_DMSO_SDMA", label_size = 2, add_names = TRUE)
plot_volcano(dep, contrast = "MS023_SDMA_vs_GSK591_SDMA", label_size = 2, add_names = TRUE)
# Plot a barplot for USP15 and IKBKG
#plot_single(dep, proteins = c("ALYREF."))
#plot_single(dep, proteins = c("CHTOP.47"))
#plot_single(dep, proteins = c("CHTOP.59"))
...
#plot pvals
hist(data_results$GSK591_SDMA_vs_DMSO_SDMA_p.val)
hist(data_results$MS023_SDMA_vs_DMSO_SDMA_p.val)
hist(data_results$MS023_SDMA_vs_GSK591_SDMA_p.val)
hist(data_results$GSK591_SDMA_vs_DMSO_SDMA_p.adj)
hist(data_results$MS023_SDMA_vs_DMSO_SDMA_p.adj)
hist(data_results$MS023_SDMA_vs_GSK591_SDMA_p.adj)
...
Peptide_Modifcations_longer <- as.data.frame(Peptide_Modifications %>% select(-name) %>%
  pivot_longer(cols= DMSO_SDMA_1:MS023_SDMA_3, names_to = c('ID')))
...
Peptide_Modifcations_longer_sum <- aggregate(Peptide_Modifcations_longer[grep('DMSO_SDMA_1', colnames(Peptide_Modifcations_longer)):grep('MS023_SDMA_3', colnames(Peptide_Modifcations_longer))], by=list(Gene.Symbol = Peptide_Modifcations_longer$Gene.Symbol, Description = Peptide_Modifcations_longer$Description, Accession = Peptide_Modifcations_longer$Accession, value = Peptide_Modifcations_longer$value), FUN=sum)
...
#write.csv(df_wide, 'GluC_SDMA_perResidue_log2FC.csv')
